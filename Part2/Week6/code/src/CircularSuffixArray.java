public class CircularSuffixArray {
    ...
    private String double_s = new String();
    ...
    private boolean less(Comparable v, Comparable w)
    {
        int a = (int) v;
        int b = (int) w;
        char char_v = double_s.charAt(a);
        char char_w = double_s.charAt(b);
        if(a==b) return false;
        if(a >= double_s.length()-1 || b >= double_s.length()-1) return true;
    ...
    public static void main(String[] args)
    {
        ...
        CircularSuffixArray4 csa = new CircularSuffixArray4(input);
        long endTime = System.currentTimeMillis();
        System.out.println("That took " + (endTime - startTime) + " milliseconds");
//        for(int i = 0; i<csa.s.length(); i++)
//        {

 ...
 ******************************************************************************/
public class CircularSuffixArray4 {
     ...
     */
    public CircularSuffixArray4(String s) {
        n = s.length();
        order = new int[n];
        for (int i = 0; i < n; i++)
            order[i] = i;
    ...
    public static void main(String[] args) {
        ...
        if(args.length > 1)
        {
            ...
            s = s.substring(0, substring_length);
        }
        int n = s.length();
        ...
        CircularSuffixArray4 csa = new CircularSuffixArray4(s);
